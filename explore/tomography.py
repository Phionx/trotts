...
class CustomTomographyFitter:
    ...
    def __init__(self,
                 ...
                 circuits: Union[List[QuantumCircuit], List[str]] = None,
                 result: Union[Result, List[Result]] = None, 
        ...
        Args:
            input_data: Processed dict of counts for each of 3^n Pauli strings 
            result: a (list of) Qiskit Result object obtained from executing
                tomography circuits.
        ...
        # Add initial data either from result or data dict
        if input_data is not None:
            self._data = self.process_input_data(input_data)
        
        elif result is not None and circuits is not None:
            self._data = {}
    ...
    def process_input_data(self, input_data: Dict):
        ...
        """
        processed_data = {}
        for pauli_string, counts in input_data.items():
            pauli_tup = tuple(pauli_string)
            processed_data[pauli_tup] = counts
    ...
    def add_data(self,
        ...
        for circ in circuits:
            ...
            for result in results:
                ...
                # This needs to be inside the for loop to add up all counts from all results! 
                if counts is None:
